...
export default async function render(page, chart, { args, libraryCode, outPath, css, view, title }) {
	/**
	...
	if (view === true) {
		...
		await showChart(chart, { args, libraryCode, now, bounds, css, title, instance });
