...
export default async function screenshotInPlaywright(
	page,
	chart,
	{ args, libraryUrls, outPath, css }
) {
	/**
	 ...
	 */
	await page.addStyleTag({ content: `body{display:table;}body > * {padding:${bodyMargin}px;}${styles}` });
