...
export default async function screenshotInPlaywright(page, chart, { args, library, libraryCode, outPath, css }) {
	/**
	...
	await page.evaluate(renderInBrowser, [args, wrapperId, library]);
